...
export default function CTA() {
  return (
    <div className="relative isolate bg-[linear-gradient(180deg,#ffffff_0%,#f9f9f9_100%)] min-h-[min(1024px,80dvh)]">
      ...
      <section className="relative z-10 flex min-h-[min(1024px,80dvh)] items-center px-4">
        <div className="max-w-[1148px] mx-auto w-full">
          <h2 className="max-w-[400px] md:text-6xl text-[30px] sm:max-w-[562px] mb-6">
            Supported by the Risk labs Foundations
          </h2>
          <p className="mb-[74px] text-lg sm:text-xl sm:max-w-[562px]">
            Risk Labs is the foundation and team behind UMA. Risk Labs&apos;
